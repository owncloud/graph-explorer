...
export const SampleQueries: ISampleQuery[] = [
  {
    ...
    "requestUrl": "/v1/me/",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/users",
    "skipTest": false
},
{
    "category": "Getting Started",
    "method": "GET",
    "humanName": "my photo",
    "requestUrl": "/v1/me/photo/$value",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/profilephoto_get",
    "skipTest": false
},
{
    "category": "Getting Started",
    "method": "GET",
    "humanName": "my mail",
    "requestUrl": "/v1/me/messages",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_messages",
    "skipTest": false
},
{
    "category": "Getting Started",
    ...
    "requestUrl": "/v1/me/drive/root/children",
...
},
{
    ...
    "requestUrl": "/v1/me/manager",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_manager",
    "skipTest": false
},
{
    "category": "Users",
    ...
    "requestUrl": "/v1/me/directReports",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_directreports",
    "skipTest": false
},
{
    "category": "Users",
...
},
{
    ...
    "requestUrl": "/v1/users?$filter=Department eq 'Finance'",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/users",
    "skipTest": false
},
{
    ...
    "method": "GET",
    "humanName": "my skills",
    "requestUrl": "/v1/me/?$select=displayName,skills",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/user",
    "skipTest": false
},
{
    "category": "Users",
...
},
{
    ...
    "requestUrl": "/v1/users",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_post_users",
    "headers": [
        {
            "name": "Content-type",
...
},
{
    ...
    "requestUrl": "/v1/users/delta?$select=displayName,givenName,surname",
...
},
{
    ...
    "requestUrl": "/v1/groups",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/group",
    "skipTest": false
},
{
    "category": "Groups",
    ...
    "requestUrl": "/v1/me/memberOf",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_memberof",
    "skipTest": false
},
{
    "category": "Groups",
    ...
    "requestUrl": "/v1/groups/{group-id}/members",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/group_list_members",
    "tip": "This query requires a group id.  To find the ID of a group you belong to, you can run: GET https://graph.microsoft.com/v1/me/memberOf",
    "skipTest": false
},
{
    "category": "Groups",
    ...
    "requestUrl": "/v1/groups/{group-id}/conversations",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/group_list_conversations",
    "tip": "This query requires a group id.  To find the ID of a group you belong to, you can run: GET https://graph.microsoft.com/v1/me/memberOf",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/groups/{group-id}/events",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/group_list_events",
    "tip": "This query requires a group id.  To find the ID of a group you belong to, you can run: GET https://graph.microsoft.com/v1/me/memberOf",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/groups/{group-id}/addFavorite",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/group_addfavorite",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/groups/{group-id}/drive/root/children",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/drive_get",
    "tip": "This query requires a group id.  To find the ID of a group you belong to, you can run: GET https://graph.microsoft.com/v1/me/memberOf",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/groups/delta?$select=displayName,description",
...
},
{
    ...
    "requestUrl": "/v1/me/messages?$filter=importance eq 'high'",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_messages",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/me/messages?$filter=(from/emailAddress/address) eq '{user-mail}'",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_messages",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/me/messages?$search=\"hello world\"",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_messages",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/me/sendMail",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_sendmail",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/messages/{message-id}/forward",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/message_forward",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
    ...
    "postBody": "{\r\n  \"comment\": \"FYI\",\r\n  \"toRecipients\": [\r\n    {\r\n      \"emailAddress\": {\r\n        \"address\": \"{user-mail}\",\r\n        \"name\": \"Alex Darrow\"\r\n      }\r\n    }\r\n  ]\r\n}",
    "tip": "This query requires a message id. To get the ID, run the following query, find the message in the response and use its ID property: GET https://graph.microsoft.com/v1/me/messages",
    "skipTest": false
},
{
    "category": "Outlook Mail",
    ...
    "requestUrl": "/v1/me/mailFolders/Inbox/messages/delta",
...
},
{
    ...
    "requestUrl": "/v1/me/events?$select=subject,body,bodyPreview,organizer,attendees,start,end,location",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_events",
    "skipTest": false
},
{
    "category": "Outlook Calendar",
    ...
    "requestUrl": "/v1/me/calendars",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_calendars",
    "skipTest": false
},
{
    "category": "Outlook Calendar",
    ...
    "requestUrl": "/v1/me/findMeetingTimes",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_findmeetingtimes",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/events",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_post_events",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/calendarView/delta?startDateTime={today}&endDateTime={next-week}",
...
},
{
    ...
    "requestUrl": "/v1/me/contacts",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_contacts",
    "skipTest": false
},
{
    "category": "Personal Contacts",
    ...
    "requestUrl": "/v1/me/contacts",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_post_contacts",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/drive/recent",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/drive_recent",
    "skipTest": false
},
{
    "category": "OneDrive",
    ...
    "requestUrl": "/v1/me/drive/sharedWithMe",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/drive_sharedwithme",
    "skipTest": false
},
{
    "category": "OneDrive",
    ...
    "requestUrl": "/v1/me/drive/root/search(q='finance')?select=name,id,webUrl",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/item_search",
    "skipTest": false
},
{
    "category": "OneDrive",
    ...
    "requestUrl": "/v1/me/drive/root/children",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/item_post_children",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/drive/items/{drive-item-id}/workbook/createSession",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/excel",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
    ...
    "tip": "This query requires a driveItem id.  To find the ID of the driveItem that corresponds to an Excel Workbook, you can run: GET https://graph.microsoft.com/v1/me/drive/root/search(q='.xlsx')?select=name,id,webUrl.",
    "skipTest": false
},
{
    "category": "Excel",
    ...
    "requestUrl": "/v1/me/drive/items/{drive-item-id}/workbook/worksheets",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/workbook_list_worksheets",
    "tip": "This query requires a driveItem id.  To find the ID of the driveItem that corresponds to an Excel Workbook, you can run: GET https://graph.microsoft.com/v1/me/drive/root/search(q='.xlsx')?select=name,id,webUrl.",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/me/drive/items/{drive-item-id}/workbook/worksheets/",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/worksheetcollection_add",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/drive/items/{drive-item-id}/workbook/functions/pmt",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/workbook#functions",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/drive/items/{drive-item-id}/workbook/worksheets('Sheet1')/usedRange",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/worksheet_usedrange",
    "tip": "This query requires a driveItem id.  To find the ID of the driveItem that corresponds to an Excel Workbook, you can run: GET https://graph.microsoft.com/v1/me/drive/root/search(q='.xlsx')?select=name,id,webUrl.",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/me/drive/items/{drive-item-id}/workbook/worksheets/Sheet1/tables",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/worksheet_list_tables",
    "tip": "This query requires a driveItem id.  To find the ID of the driveItem that corresponds to an Excel Workbook, you can run: GET https://graph.microsoft.com/v1/me/drive/root/search(q='.xlsx')?select=name,id,webUrl.",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/me/drive/items/{drive-item-id}/workbook/worksheets('Sheet1')/charts",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/worksheet_list_charts",
    "tip": "This query requires a driveItem id.  To find the ID of the driveItem that corresponds to an Excel Workbook, you can run: GET https://graph.microsoft.com/v1/me/drive/root/search(q='.xlsx')?select=name,id,webUrl.",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/groups/{group-id-with-plan}/planner/plans",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannergroup_list_plans",
    "tip": "This query requires a group id.  To find the ID of a group you belong to, you can run: GET https://graph.microsoft.com/v1/me/memberOf",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/planner/plans/{plan-id}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannerplan_get",
    "tip": "This query requires a plan id.  To find the ID of the plan you can run: GET https://graph.microsoft.com/v1/me/groups/{group-id}/plans.",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/planner/plans/{plan-id}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannerplan_update",
    "headers": [
        {
            "name": "If-Match",
            "value": "{if-match}"
    ...
    "tip": "This query requires a Plan ID and value of @odata.etag for a selected task. To find the ID of the Plan, you can run: GET https://graph.microsoft.com/v1/me/planner/tasks. To get the @odata.etag, run: GET https://graph.microsoft.com/v1/planner/plans/{plan-id}",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/planner/plans/{plan-id}/buckets",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannerplan_list_buckets",
    "tip": "This query requires a plan id.  To find the ID of the plan you can run: GET https://graph.microsoft.com/v1/me/groups/{group-id}/plans.",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/planner/buckets",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/planner_post_buckets",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
    ...
    "postBody": "{\r\n  \"name\": \"{bucket-name}\",\r\n  \"planId\": \"{plan-id}\",\r\n  \"orderHint\": \" !\"\r\n}",
    "tip": "This query requires a Plan id.  To find the ID of the Plan you can run: GET https://graph.microsoft.com/v1/me/planner/plans",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/planner/buckets/{bucket-id}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannerbucket_update",
    "headers": [
        {
            "name": "If-Match",
            "value": "{if-match}"
    ...
    "tip": "This query requires a bucket id and value of @odata.etag for a selected bucket.  To find the ID of the bucket run: GET https://graph.microsoft.com/v1/planner/plans/{plan-id}/buckets and then run: GET https://graph.microsoft.com/v1/planner/buckets/{bucket-id} to discover @odata.etag",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/planner/plans/{plan-id}/tasks",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannerplan_list_tasks",
    "tip": "This query requires a plan id.  To find the ID of the plan you can run: GET https://graph.microsoft.com/v1/me/groups/{group-id}/plans.",
    "skipTest": false
},
{
    ...
    "method": "GET",
    "humanName": "all my Planner tasks",
    "requestUrl": "/v1/me/planner/tasks",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/planner_overview",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/users/{coworker-mail}/planner/tasks",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/planneruser_list_tasks",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/planner/tasks/{task-id}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannertask_get",
    "tip": "This query requires a task id.  To find the ID of the task you can run: GET https://graph.microsoft.com/v1/me/planner/tasks",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/planner/tasks",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/planner_post_tasks",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
    ...
    "postBody": "{\r\n  \"planId\": \"{plan-id}\",\r\n  \"title\": \"{task-title}\",\r\n  \"assignments\": {}\r\n}",
    "tip": "This query requires a Plan id.  To find the ID of the Plan you can run: GET https://graph.microsoft.com/v1/me/planner/tasks",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/planner/tasks/{task-id}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannertask_update",
    "headers": [
        {
            "name": "If-Match",
            "value": "{if-match}"
    ...
    "tip": "This query requires a task id and value of @odata.etag for a selected task.  To find the ID of the task and @odata.etag you can run: GET https://graph.microsoft.com/v1/me/planner/tasks",
    "skipTest": false
},
{
    "category": "Planner",
    ...
    "requestUrl": "/v1/planner/tasks/{task-id}/details",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/plannertaskdetails_get",
    "tip": "This query requires a task id.  To find the ID of the task you can run: GET https://graph.microsoft.com/v1/me/planner/tasks",
    "skipTest": false
},
{
...
},
{
    ...
    "requestUrl": "/v1/me/people",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_people",
    "skipTest": false
},
{
    "category": "People",
    ...
    "requestUrl": "/v1/me/people/?$search=j",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/person_get",
    "skipTest": false
},
{
    "category": "People",
    ...
    "requestUrl": "/v1/me/people/?$search=\"topic: contoso\"",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/person_get",
    "skipTest": false,
},
{
    ...
    "requestUrl": "/v1/me?$select=id,displayName,mail,mobilePhone&$expand=extensions",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/opentypeextension",
    "skipTest": false
},
{
    "category": "Extensions",
    ...
    "requestUrl": "/v1/me/extensions",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/opentypeextension_post_opentypeextension",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/extensions/{extension-id}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/opentypeextension_update",
    "postBody": "{\r\n    \"theme\":\"light\",\r\n    \"color\":\"yellow\",\r\n    \"lang\":\"Swahili\"\r\n}",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/schemaExtensions",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/schemaextension_post_schemaextensions",
    "skipTest": false
},
{
    "category": "Extensions",
    ...
    "requestUrl": "/v1/groups?$filter=adatumisv_courses/id eq '123'&$select=id,displayName,adatumisv_courses",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/schemaextension_post_schemaextensions",
    "skipTest": false
},
{
...
},
{
    ...
    "requestUrl": "/v1/me/onenote/notebooks",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/onenote",
    "skipTest": false
},
{
    "category": "OneNote",
    ...
    "requestUrl": "/v1/me/onenote/sections",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/resources/section",
    "skipTest": false
},
{
    "category": "OneNote",
    "method": "GET",
    "humanName": "my pages",
    "requestUrl": "/v1/me/onenote/pages",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/section_list_pages",
    "skipTest": false
},
{
    "category": "OneNote",
    ...
    "requestUrl": "/v1/me/onenote/notebooks",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/onenote_post_notebooks",
...
},
{
    ...
    "requestUrl": "/v1/me/onenote/notebooks/{notebook-id}/sections",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/notebook_post_sections",
    "headers": [
        {
            "name": "Content-type",
            "value": "application/json"
    ...
    "tip": "This query requires a notebook id.  To find the ID, you can run: GET https://graph.microsoft.com/v1/me/onenote/notebooks. ",
    "skipTest": false
},
{
    "category": "OneNote",
    ...
    "requestUrl": "/v1/me/onenote/sections/{section-id}/pages",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/section_post_pages",
    "headers": [
        {
            "name": "Content-type",
    ...
    "tip": "This query requires a section id.  To find the ID, you can run: GET https://graph.microsoft.com/v1/me/onenote/sections.",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/sites/root",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/site_get",
    "skipTest": false
},
{
    "category": "SharePoint Sites",
    ...
    "requestUrl": "/v1/sites/root/drives",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/drive_list#list-a-sites-drives",
    "skipTest": false
},
{
    "category": "SharePoint Sites",
    ...
    "requestUrl": "/v1/sites/{host-name}:/{server-relative-path}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/site_getbypath",
    "skipTest": false
},
{
    "category": "SharePoint Sites",
    ...
    "requestUrl": "/v1/sites?search=contoso",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/site_search",
    "skipTest": false
},
{
    "category": "SharePoint Sites",
    ...
    "requestUrl": "/v1/sites/root/sites",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/site_list_subsites",
    "skipTest": false
},
{
    "category": "SharePoint Sites",
    ...
    "requestUrl": "/v1/sites/root/columns",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/site_list_columns",
    "skipTest": false
},
{
    "category": "SharePoint Sites",
    ...
    "requestUrl": "/v1/sites/root/contentTypes",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/site_list_contenttypes",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/sites/root/lists",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/list_list",
    "skipTest": false
},
{
    "category": "SharePoint Lists",
    ...
    "requestUrl": "/v1/sites/root/lists/{list-id}/columns",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/list_list_columns",
    "skipTest": false
},
{
    "category": "SharePoint Lists",
    ...
    "requestUrl": "/v1/sites/root/lists/{list-id}/contentTypes",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/list_list_contenttypes",
    "skipTest": false
},
{
    "category": "SharePoint Lists",
    ...
    "requestUrl": "/v1/sites/root/lists/{list-id}/items",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/listitem_list",
    "skipTest": false
},
{
    "category": "SharePoint Lists",
    ...
    "requestUrl": "/v1/sites/root/lists/{list-id}/items?$filter=fields/Title eq '{list-title}'",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/listitem_list",
    "headers": [
        {
            "name": "Prefer",
...
},
{
    ...
    "requestUrl": "/v1/me/joinedTeams",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/user_list_joinedteams",
    "skipTest": false
},
{
    "category": "Microsoft Teams",
    ...
    "requestUrl": "/v1/groups/{group-id-for-teams}/members",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/group_list_memberof",
    "tip": "This query requires a group id of the Team.  To find the group id of teams you belong to, you can run: GET https://graph.microsoft.com/v1/me/joinedTeams",
    "skipTest": false
},
{
    "category": "Microsoft Teams",
    ...
    "requestUrl": "/v1/teams/{team-id}/channels",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/channel_list",
    "tip": "This query requires a team id.  To find the team id of teams you belong to, you can run: GET https://graph.microsoft.com/v1/me/joinedTeams",
    "skipTest": false
},
{
    "category": "Microsoft Teams",
    ...
    "requestUrl": "/v1/teams/{team-id}/channels/{channel-id}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/channel_get",
    "tip": "This query requires a team id and a channel id from that team. To find the team id  & channel id, you can run: 1) GET https://graph.microsoft.com/v1/me/joinedTeams 2) GET https://graph.microsoft.com/v1/teams/{team-id}/channels",
    "skipTest": false
},
{
    "category": "Microsoft Teams",
    ...
    "requestUrl": "/v1/teams/{team-id}/channels",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/channel_post",
...
},
{
    ...
    "requestUrl": "/v1/teams/{team-id}/installedApps?$expand=teamsAppDefinition",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/teamsappinstallation_list",
    "tip": "This query requires a team id. To find the team id, you can run: GET https://graph.microsoft.com/v1/me/joinedTeams",
    "skipTest": false
},
{
    "category": "Microsoft Teams",
    ...
    "requestUrl": "/v1/teams/{team-id}/channels/{channel-id}/tabs?$expand=teamsApp",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/teamstab_list",
    "tip": "This query requires a team id and a channel id from that team. To find the team id  & channel id, you can run: 1) GET https://graph.microsoft.com/v1/me/joinedTeams 2) GET https://graph.microsoft.com/v1/teams/{team-id}/channels",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/groups/{group-id-for-teams}/drive/root/children",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/item_list_children",
    "tip": "This query requires a group id of the Team.  To find the group id of Teams you belong to, you can run: GET https://graph.microsoft.com/v1/me/joinedTeams",
    "skipTest": false
},
{
...
},
{
    ...
    "method": "GET",
    "humanName": "alerts",
    "requestUrl": "/v1/security/alerts?$top=1",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/alert_list",
    "skipTest": false
},
{
    "category": "Security",
    ...
    "requestUrl": "/v1/security/alerts?$filter=Severity eq 'High'&$top=5",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/alert_list",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/security/alerts?$filter=vendorInformation/provider eq 'ASC'&$top=5",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/alert_list",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/security/alerts?$filter=Category eq 'ransomware'&$top=5",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/alert_list",
    "skipTest": false
},
{
    ...
    "requestUrl": "/v1/security/alerts?$filter=networkConnections/any(d:d/destinationAddress eq '{destination-address}')",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/alert_list",
    "tip": "This query requires a destination address. Run https://graph.microsoft.com/v1/security/alerts?$top=1 and search the results for a destinationAddress property.",
    "skipTest": false
},
{
    "category": "Security",
    ...
    "requestUrl": "/v1/security/alerts?$filter=Status eq 'NewAlert'&$top=1",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/alert_list",
    "skipTest": false
},
{
...
},
{
    ...
    "requestUrl": "/v1/security/alerts/{alert-id}",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/alert_update",
    "postBody": "{\r\n  \"assignedTo\": \"test@contoso.com\",\r\n  \"comments\": [\"Comment 0\", \"Comment 1\"],\r\n  \"tags\": [\"Tag 0\", \"Tag 1\"],\r\n  \"feedback\": \"truePositive\",\r\n  \"status\": \"newAlert\",\r\n  \"vendorInformation\": {\r\n    \"provider\": \"provider\",\r\n    \"providerVersion\": \"3.0\",\r\n    \"subProvider\": null,\r\n    \"vendor\": \"vendor\"\r\n  }\r\n}",
    "tip": "This query requires an alert id. To find the ID of the alert, you can run: GET https://graph.microsoft.com/v1/security/alerts?$top=1",
    "skipTest": false
},
{
    "category": "Security",
...
},
{
    ...
    "requestUrl": "/v1/me/activities/uniqueIdInAppContext",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/projectrome_put_activity#example-2---deep-insert",
    "headers": [
        {
            "name": "Content-Type",
            "value": "application/json"
...
},
{
    ...
    "requestUrl": "/v1/me/activities/recent",
    "docLink": "https://developer.microsoft.com/en-us/graph/docs/api-reference/v1/api/projectrome_get_recent_activities",
    "skipTest": false
},
{
